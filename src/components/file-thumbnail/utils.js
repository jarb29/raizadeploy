...
const PersonaliconUrl = (icon) => `/assets/icon_personal/${icon}.svg`;
// ----------------------------------------------------------------------
...
export function fileThumb(fileUrl) {
  ...
  // console.log(fileFormat(fileUrl), 'fileUrl');
  ...
  switch (fileFormat(fileUrl)) {
    ...
    case 'CEBOLLA':
      ...
      break;
    case 'ZAPALLO':
      thumb = PersonaliconUrl('ZAPALLO');
      break;
    case 'LECHUGA':
      thumb = PersonaliconUrl('LECHUGA');
      break;
    case 'PAPA':
      thumb = PersonaliconUrl('PAPA');
      break;
    case 'CEBOLLIN':
      thumb = PersonaliconUrl('CEBOLLIN');
      break;
    case 'ESPINACA':
      thumb = PersonaliconUrl('ESPINACA');
      break;
    case 'ZANAHORIA':
      thumb = PersonaliconUrl('ZANAHORIA');
      break;
    case 'APIO':
      thumb = PersonaliconUrl('APIO');
      break;
    case 'BETARRAGA':
      thumb = PersonaliconUrl('BETARRAGA');
      break;
    case 'REPOLLO':
      thumb = PersonaliconUrl('REPOLLO');
      break;
    case 'MIX':
      thumb = PersonaliconUrl('MIX');
      break;
    case 'All':
      thumb = iconUrl('ic_folder');
      break;
    case 'ACELGA':
      thumb = PersonaliconUrl('ACELGA');
      break;
    case 'DIENTE':
      thumb = PersonaliconUrl('DIENTE');
      break;
    default:
