...
export default function RHFAutocomplete({ name, label, type, helperText, placeholder,freeSolo = false, ...other }) {
        ...
        if (type === 'country') {
          return (
            <Autocomplete
              ...
              freeSolo={freeSolo} // Add this line
...
RHFAutocomplete.propTypes = {
  ...
  freeSolo: PropTypes.bool, // Add this line
};
